...
public class G1Test {
    ...
    public void addTest1() {
        ...
        try {
            ...
            System.out.println("g1EcAdd DIV.test 1 took " + ms + " ms");
        } catch (Exception e) {
    ...
    public void addTest2() {
        ...
        try {
            ...
            c = G1.add(a, b);
            long ms = TimeUnit.MILLISECONDS.convert(System.nanoTime() - start, TimeUnit.NANOSECONDS);
            System.out.println("g1EcAdd DIV.test 2 took " + ms + " ms");
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    ...
    public void mulTest1() {
        ...
        try {
            ...
            q = G1.mul(p, s);
            long ms = TimeUnit.MILLISECONDS.convert(System.nanoTime() - start, TimeUnit.NANOSECONDS);
            System.out.println("g1EcMul DIV.test 1 took " + ms + " ms");
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    ...
    public void mulTest2() {
        ...
        try {
            ...
            long ms = TimeUnit.MILLISECONDS.convert(System.nanoTime() - start, TimeUnit.NANOSECONDS);
            System.out.println("g1EcMul DIV.test 2 took " + ms + " ms");
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
