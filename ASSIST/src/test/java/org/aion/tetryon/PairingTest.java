...
public class PairingTest {
    ...
    public void pairingProd2Test() {
        ...
        try {
            ...
            r2 = Pairing.pairingProd2(g11, G2.ECTwistMul(g2,BigInteger.valueOf(100)), G1.negate(G1.mul(g11,BigInteger.valueOf(100))), g2);
            long ms = TimeUnit.MILLISECONDS.convert(System.nanoTime() - start, TimeUnit.NANOSECONDS);
            System.out.println("ecPair pairingProd2 DIV.test took " + ms + " ms");
        } catch (Exception e) {
